    ...
    <div>
      ...
      <img className='w-full md:max-w-[360px]' src={assets.contact_image} alt="" />
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>{t('Tel: (415) 555-0132')} <br /> {t('Email: greatstackdev@gmail.com')}</p>
          <p className='font-semibold text-lg text-gray-600'>{t('CAREERS AT PRESCRIPTO')}</p>
